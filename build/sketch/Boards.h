#line 1 "/Users/refactored/Code/Ad_Hoc/RNode_Firmware_CE/Boards.h"
...
#include "ROM.h"
  ...
  #define VALIDATE_FIRMWARE true
    ...
    // the makefile, or auto-detected from the Arduino FQBN (e.g. lilygo_t3s3).
    // To override when using the IDE or arduino-cli with a board FQBN, define
    // BOARD_MODEL and optionally BOARD_VARIANT before including this file.
    //
    #ifndef BOARD_MODEL
      #if defined(ARDUINO_LILYGO_T3_S3) || defined(LILYGO_T3_S3)
        #define BOARD_MODEL BOARD_T3S3
        #ifndef BOARD_VARIANT
          #define BOARD_VARIANT MODEL_A1
        #endif
      #elif defined(ARDUINO_LILYGO_T3S3_SX1262) || defined(LILYGO_T3S3_SX1262)
        #define BOARD_MODEL BOARD_T3S3
        #define BOARD_VARIANT MODEL_A1
      #elif defined(ARDUINO_LILYGO_T3S3_SX1276) || defined(LILYGO_T3S3_SX1276)
        #define BOARD_MODEL BOARD_T3S3
        #define BOARD_VARIANT MODEL_AA
      #elif defined(ARDUINO_LILYGO_T3S3_SX1278) || defined(LILYGO_T3S3_SX1278)
        #define BOARD_MODEL BOARD_T3S3
        #define BOARD_VARIANT MODEL_A5
      #elif defined(ARDUINO_LILYGO_T3S3_SX1280) || defined(LILYGO_T3S3_SX1280)
        #define BOARD_MODEL BOARD_T3S3
        #define BOARD_VARIANT MODEL_AC
      #elif defined(ARDUINO_LILYGO_T3S3_SX1280PA) || defined(LILYGO_T3S3_SX1280PA)
        #define BOARD_MODEL BOARD_T3S3
        #define BOARD_VARIANT MODEL_AC
      #endif
    #endif
    ...
    #define PIN_GPS_RX 34
      ...
      // NOTE: GPIO12 is a strapping pin on ESP32 and can cause boot issues if
      // driven by external circuitry at reset (e.g. NeoPixel data line).
      // Default to GPIO13 for external NeoPixel data.
      #ifndef PIN_NEOPIXEL
        #define PIN_NEOPIXEL 13
      #endif
      const int pin_np = PIN_NEOPIXEL;
